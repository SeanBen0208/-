...
num_stages = 10
investment_amounts = [2000] * 3 + [570] * 6 + [580]
...
# 종목당 투자 금액 검증
if total_per_stock != total_investment / num_stocks:
...
for symbol in valid_symbols:
    ...
    # 기본 퍼센트 설정
    if symbol == 'TSLA':
        base_buy_percentages = [5.0] * 3 + [7.0] * 3 + [10.0] * 4
        base_sell_percentages = [8.0] * 3 + [12.0] * 3 + [18.0] * 4
    else:  # INOD
        base_buy_percentages = [6.0] * 3 + [8.0] * 3 + [12.0] * 4
        base_sell_percentages = [15.0] * 3 + [25.0] * 3 + [40.0] * 4
